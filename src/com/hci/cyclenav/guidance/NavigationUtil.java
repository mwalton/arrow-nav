...
public class NavigationUtil {
	...
	public String distanceStr(GeoPoint from, Location to, double mileThreshold) {
		...
		// if the distance is smaller than threshold, measure in ft instead of
		// miles
	...
	public int getManeuverIcon(GuidanceNode g) {
		...
		// left arrow cases
		else if (m == maneuver.SHARP_LEFT || m == maneuver.STAY_LEFT
				|| m == maneuver.LEFT) {
			return R.drawable.left;
		}
		// right arrow cases
		else if (m == maneuver.SHARP_RIGHT || m == maneuver.STAY_RIGHT
				|| m == maneuver.RIGHT) {
